...
class WebFilteringDatabaseClient {
  WebFilteringDatabaseClient(
      {required this.apiKey,
      String? baseUrl,
      http.Client? httpClient,
      this.timeout = const Duration(seconds: 30)})
      : baseUrl = (baseUrl ?? 'https://www.webfilteringdatabase.com/api')
  ...
  Future<ApiResult> _lookup(String value) async {
    ...
    final endpoint = Uri.parse('$baseUrl/moderate.php');
